...
{
    class Bow : Component, IUpdateable, ILoadable, IAnimateable, ICollisionStay, ICollisionEnter, ICollisionExit
    {
        Vector2 mousePos;
        Vector2 playerPos;
        ...
        public Bow(GameObject gameObject, Player player) : base(gameObject)
        {
            this.player = player;
        ...
        public void Update()
        {
            if (GameWorld.Instance.GetIsOnGroundBow)
            {
