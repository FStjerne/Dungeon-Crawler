...
{
    public class BattleAxe : Component, IUpdateable, ILoadable, IAnimateable, ICollisionStay, ICollisionEnter, ICollisionExit
    {
        Vector2 mousePos;
        Vector2 playerPos;
        ...
        public BattleAxe(GameObject gameObject, Player player) : base(gameObject)
        {
            this.player = player;
        ...
        public void Update()
        {
            if (GameWorld.Instance.GetIsOnGroundBattleAxe)
            {
